...
def train(model, local_rank):
    ...
    for epoch in range(args.epoch):
        for i, data in enumerate(train_data):
            ...
            pred, flow, metric0, metric1, loss_l1, loss_lpips, l_d_real, l_d_fake = model.update(imgs, gt, learning_rate, True, timestep, step, args.step_per_epoch)
            ...
            if step % 20 == 1 and local_rank == 0:
                ...
                writer.add_scalar('GAN/real', l_d_real, step)
                writer.add_scalar('GAN/fake', l_d_fake, step)
