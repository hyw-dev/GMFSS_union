...
class AnimeInterp(nn.Module):
    ...
    def forward(self, I1, I2, reuse_things, merged, t):
        F12, Z1 = reuse_things[0], reuse_things[2]
        F21, Z2 = reuse_things[1], reuse_things[3]
        ...
        norm1 = warp(one10, F1t.clone(), Z1, strMode='soft')
        ...
        norm2 = warp(one20, F2t.clone(), Z2, strMode='soft')
        ...
        norm1t1 = warp(one11, F1t.clone(), Z1, strMode='soft')
        ...
        norm2t1 = warp(one21, F2t.clone(), Z2, strMode='soft')
        ...
        norm1t2 = warp(one12, F1tdd.clone(), Z1dd, strMode='soft')
        ...
        norm2t2 = warp(one22, F2tdd.clone(), Z2dd, strMode='soft')
        ...
        norm1t3 = warp(one13, F1tddd.clone(), Z1ddd, strMode='soft')
        ...
        norm2t3 = warp(one23, F2tddd.clone(), Z2ddd, strMode='soft')
        ...
        return torch.clamp(It_warp, 0, 1), It_warp